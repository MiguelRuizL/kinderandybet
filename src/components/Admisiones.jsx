...
const cicloEscolar = utilsService.getCicloEscolar();
const steps = [
  {
    icon: FileText,
    step: '01',
    ...
    <section id="admisiones">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <span className="inline-block bg-secondary/20 text-amber-600 font-semibold px-4 py-2 rounded-full text-sm mb-4">
            Admisiones
          </span>
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="bg-primary rounded-3xl p-8 text-white text-center lg:text-left">
            ...
            <p className="text-white/80 mb-6">
              Inscripciones abiertas para el ciclo escolar {cicloEscolar}. 
